...
const common_1 = __webpack_require__(6);
const diagnostics_1 = __webpack_require__(9);
let HealthcheckService = class HealthcheckService {
    constructor() { }
    getDiagnostics() {
        return Promise.resolve({
            serviceHealth: diagnostics_1.HealthStatus.Up,
            databaseHealth: diagnostics_1.HealthStatus.Down,
            cacheHealth: diagnostics_1.HealthStatus.Down,
        });
    }
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Diagnostics = exports.HealthStatus = void 0;
var HealthStatus;
